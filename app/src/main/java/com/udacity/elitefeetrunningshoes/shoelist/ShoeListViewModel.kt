    ...
    private fun setShoeList() {
        _shoeList.value = mutableListOf(
            Shoe(
                ...
                "Nike",
                "road racing",
                listOf("https://www.nike.com/t/alphafly-3-mens-road-racing-shoes-6Nc43S/FD8311-700?_gl=1*1eq92ol*_up*MQ..&gclid=Cj0KCQjwztOwBhD7ARIsAPDKnkBTwhStCeMqXQwLSXyRKoHdEYt4uaHsfBS7BpOy1GSNHsrLVdRPimgaAtn_EALw_wcB&gclsrc=aw.ds")
            ),
            Shoe(
                "Alphafly 3",
                8.0,
            ...
            Shoe(
                ...
                listOf("https://www.nike.com/t/pegasus-40-mens-road-running-shoes-extra-wide-zD8H1c/DV3853-102https://www.nike.com/t/zoomx-dragoy-track-field-distance-spikes-0P9jtc/CV0400-101")
            ),
            Shoe(
            ...
            Shoe(
                ...
                "Saucony",
                "daily trainer",
                listOf("https://www.saucony.com/en/endorphin-speed-4/58852M.html?dwvar_58852M_color=S20940-129#cgid=mens-running&prefn1=isOnSale&prefv1=false&start=1")
            ),
            Shoe(
                "Kinvara Pro",
                11.0,
                "Saucony",
                "daily trainer",
                listOf("https://www.saucony.com/en/kinvara-pro/56633M.html?dwvar_56633M_color=S20847-138#cgid=mens-running&prefn1=isOnSale&prefv1=false&start=1")
            ),
            ...
            Shoe(
                ...
                "Saucony",
                "road racing",
                listOf("https://www.saucony.com/en/endorphin-pro-3/52954M.html?dwvar_52954M_color=S20755-33#cgid=mens-running&prefn1=isOnSale&prefv1=false&start=1")
            ),
            Shoe(
                ...
                "New Balance",
                "road racing",
                listOf("https://www.newbalance.com/pd/fuelcell-supercomp-elite-v4/MRCELV4-44901.html?dwvar_MRCELV4-44901_style=MRCELLA4")
            ),
            Shoe(
                "FuelCell SuperComp Elite v4",
                8.0,
            ...
            Shoe(
                ...
                "New Balance",
                "daily trainer",
                listOf("https://www.newbalance.com/pd/fuelcell-rebel-v4/MFCXV4-41132.html?dwvar_MFCXV4-41132_style=MFCXLK4")
            ),
            Shoe(
                ...
                "New Balance",
                "max cushioned",
                listOf("https://www.newbalance.com/pd/fuelcell-supercomp-trainer-v2/MRCXV3-45183.html?dwvar_MRCXV3-45183_style=MRCXCA3")
            ),
            Shoe(
